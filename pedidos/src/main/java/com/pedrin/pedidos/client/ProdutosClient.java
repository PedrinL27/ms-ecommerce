...
import com.pedrin.pedidos.client.representation.ProdutoRepresentation;
...
public interface ProdutosClient {
    ...
    ResponseEntity<ProdutoRepresentation> obterHistorico(@PathVariable("codigo") Long codigo);
}
